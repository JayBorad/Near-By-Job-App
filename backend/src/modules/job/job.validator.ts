...
export const createJobValidator = [
  ...
  body('budgetType').optional().isIn(['TOTAL', 'PER_PERSON']).withMessage('Invalid budget type'),
  body('jobType').isIn(['ONE_TIME', 'PART_TIME', 'FULL_TIME']).withMessage('Invalid job type'),
  body('workMode').optional().isIn(['REMOTE', 'HYBRID', 'ONSITE']).withMessage('Invalid work mode'),
...
export const updateJobValidator = [
  ...
  body('budgetType').optional().isIn(['TOTAL', 'PER_PERSON']),
